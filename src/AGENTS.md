...
- Main CI job (`.github/workflows/ci.yml`): charity-adjusted wealth drift check → lint → skills sync check → coverage-gated tests (50% floors) → build; tests and build each generate their data.
